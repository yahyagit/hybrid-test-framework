...
public class AndroidGestureTest extends BaseTest {
    ...
    @Test public void singleTapTest() throws Exception {
        android().activity().startActivity("io.appium.android.apis", ".view.Buttons1");
        Point point = android().find().findElementById("io.appium.android.apis:id/button_toggle")
            .getLocation();
        android().touchShortcuts().tap(1, point.x + 20, point.y + 30, 1000);
        assertEquals("ON",
            android().find().findElementById("io.appium.android.apis:id/button_toggle").getText());
    }

    @Test public void singleElementTapTest() throws Exception {
        android().activity().startActivity("io.appium.android.apis", ".view.Buttons1");
        android().touchShortcuts()
            .tap(1, android().find().findElementById("io.appium.android.apis:id/button_toggle"),
                1000);
        assertEquals("ON",
            android().find().findElementById("io.appium.android.apis:id/button_toggle").getText());
    }
    ...
    @Test public void multiTapActionTest() throws Exception {
        ...
        AndroidElement chronometer =
            android().find().findElementById("io.appium.android.apis:id/chronometer");

        TouchAction startStop =
            new TouchAction((AppiumDriver) context().getCurrentContext().getDriver())
                .tap(android().find().findElementById("io.appium.android.apis:id/start"))
                .waitAction(2000)
                .tap(android().find().findElementById("io.appium.android.apis:id/stop"));
        ...
        TouchAction reset =
            new TouchAction((AppiumDriver) context().getCurrentContext().getDriver())
                .tap(android().find().findElementById("io.appium.android.apis:id/reset"));
        MultiTouchAction m2 =
            new MultiTouchAction((AppiumDriver) context().getCurrentContext().getDriver())
    ...
    @Test public void dragNDropTest() throws Exception {
        android().activity().startActivity("io.appium.android.apis", ".view.DragAndDropDemo");
        WebElement dragDot1 =
            android().find().findElement(By.id("io.appium.android.apis:id/drag_dot_1"));
        WebElement dragDot3 =
            android().find().findElement(By.id("io.appium.android.apis:id/drag_dot_3"));

        WebElement dragText =
            android().find().findElement(By.id("io.appium.android.apis:id/drag_text"));
    ...
    @Test public void zoomAndPinchTest() throws Exception {
        ...
        MobileElement e = android().find().findElement(MobileBy.AccessibilityId("App"));
        e.zoom();
        e.pinch();
    }
    ...
    @Test public void reusableTapTest() throws Exception {
        ...
        AndroidElement element =
            android().find().findElementById("io.appium.android.apis:id/button_toggle");
        TouchAction tap =
    ...
    @Test public void verticalSwipingTest() throws Exception {
        ...
        AndroidElement listView =
            android().find().findElement(By.className("android.widget.ListView"));
    ...
    @Test public void horizontalSwipingTest() throws Exception {
        android().activity().startActivity("io.appium.android.apis", ".view.Gallery1");

        AndroidElement gallery =
            android().find().findElementById("io.appium.android.apis:id/gallery");
