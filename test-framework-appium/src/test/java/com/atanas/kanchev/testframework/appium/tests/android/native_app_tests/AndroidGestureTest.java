...
public class AndroidGestureTest extends BaseTest implements IContext {
    ...
    public void singleTapTest() throws Exception {
        android()
                .activity()
                .startActivity("io.appium.android.apis", ".view.Buttons1");
        Point point =
                android()
                        .find()
                        .findElementById("io.appium.android.apis:id/button_toggle")
                        .getLocation();
        android()
                .touchShortcuts()
    ...
    public void singleElementTapTest() throws Exception {
        ...
        android()
                ...
                .tap(1, android()
                        .find()
                        .findElementById("io.appium.android.apis:id/button_toggle"), 1000);
    ...
    public void multiTapActionTest() throws Exception {
        android().
                activity()
                .startActivity("io.appium.android.apis", ".view.ChronometerDemo");
        AndroidElement chronometer =
                android()
                        .find()
                        .findElementById("io.appium.android.apis:id/chronometer");
        ...
        TouchAction startStop = new TouchAction((AppiumDriver) context().getCurrentContext().getDriver())
                ...
                .tap(android()
                        .find()
                        .findElementById("io.appium.android.apis:id/stop"));
    ...
    public void dragNDropTest() throws Exception {
        ...
        WebElement dragDot1 = android().find().findElement(By.id("io.appium.android.apis:id/drag_dot_1"));
        WebElement dragDot3 = android().find().findElement(By.id("io.appium.android.apis:id/drag_dot_3"));

        WebElement dragText = android().find().findElement(By.id("io.appium.android.apis:id/drag_text"));
    ...
    public void horizontalSwipingTest() throws Exception {
        android()
                .activity()
                .startActivity("io.appium.android.apis", ".view.Gallery1");

        AndroidElement gallery = android().find().findElementById("io.appium.android.apis:id/gallery");
