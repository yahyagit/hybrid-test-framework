...
/**
 * Created by atanas on 28/09/16.
 */
public class GetWrappedElement extends AbstractElementInteraction {

    public GetWrappedElement(ContextKey<SeleniumContext> currentContextKey) {
